...
@section('title', 'About Us — SmartAgro')
...
<section class="section-hero-marketplace" style="background:linear-gradient(135deg, #1b5e20 0%, #2e7d32 100%);color:#fff;">
  <div class="container">
    <div class="section-header" style="color:#fff;">
      <div class="section-eyebrow" style="background:rgba(255,255,255,0.15);color:#fff;">About Us</div>
      <h1 class="text-white">About SmartAgro</h1>
      <p style="color:rgba(255,255,255,0.9);max-width:600px;">Connecting farmers, buyers and agricultural markets through digital innovation.</p>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 mb-4 mb-lg-0">
        <img src="{{ asset('dist/img/agribusiness.jpg') }}" alt="About SmartAgro" class="img-fluid rounded-lg shadow-lg" style="object-fit:cover;width:100%;height:400px;">
      </div>
      <div class="col-lg-6 ps-lg-5">
        ...
        <a href="{{ route('mission') }}" class="btn-agro">Learn More About Us <i class="fas fa-arrow-right ml-2"></i></a>
      </div>
    </div>
  </div>
</section>
